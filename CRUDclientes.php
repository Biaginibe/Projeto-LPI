...
<body>
    ...
    <form method="POST" action="inserirDadosCliente.php">
        <div id="registra">
            <label>Empresa:</label>
            <input type="text" name="cxempresa" /><br />
            <label>Endereço:</label>
            <input type="text" name="cxend" /><br />
            <label>Contato:</label>
            <input type="text" name="cxcontato" /><br />
            <label>CNPJ:</label>
            <input type="number" name="cxcnpj" /><br />
        </div>
        <div id="q">
            <input class="btn" type="submit" value=Registrar />
            <a href="listarClientes.php" class="btn">Listar Clientes</a>
        </div>
    </form>
